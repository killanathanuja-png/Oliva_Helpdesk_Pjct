...
const roleAccess: Record<string, string[]> = {
  ...
  "Manager": ["/", "/tickets", "/approvals", "/sla-report", "/analytics"],
  "MANAGER": ["/", "/tickets", "/approvals", "/sla-report", "/analytics"],
  ...
  "Zenoti Team": ["/", "/tickets", "/approvals", "/sla-report", "/analytics"],
  "Zenoti Team Manager": ["/", "/tickets", "/approvals", "/sla-report", "/analytics", "/admin/users", "/admin/departments", "/admin/roles", "/admin/centers", "/admin/categories", "/admin/subcategories", "/admin/child-categories"],
  ...
  "Helpdesk Admin": ["/", "/tickets", "/sla-report", "/analytics", "/certificates"],
